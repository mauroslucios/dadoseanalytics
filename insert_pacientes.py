...
with open("insert_pacientes_clinica.sql", "w", encoding="utf-8") as f:
    f.write("INSERT INTO tb_pacientes (nome) VALUES\n")
...
print("Arquivo insert_pacientes.sql gerado com sucesso!")
